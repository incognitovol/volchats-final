...
tabLogin && (tabLogin.onclick = () => setTab("login"));
tabSignup && (tabSignup.onclick = () => setTab("signup"));
goSignup && (goSignup.onclick = (e) => { e.preventDefault(); setTab("signup"); });
goLogin && (goLogin.onclick = (e) => { e.preventDefault(); setTab("login"); });
...
// Microsoft button click (ONLY ONCE)
msBtn && (msBtn.onclick = (e) => {
e.preventDefault();
hide(signupMsg);
...
sendCodeBtn && (sendCodeBtn.onclick = async () => {
hide(signupMsg);
